      ...
      <Stack.Screen
        options={{
          ...
          headerRight: () => (
            <Pressable
              onPress={() =>
                router.push("/(dealer-manager)/staffs/create" as const)
              }
      ...
      {loading && items.length === 0 ? (
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <Pressable
              onPress={() =>
                router.push(`/(dealer-manager)/staffs/${item.id}` as const)
              }
            ...
            >
              ...
              <Text className="text-white/50 mt-1 text-sm">
